/*!
* Helper utility for getting the style of a Outlook Style.
*
...
export const getOutlookCardStyle = (level: OutlookLevel): OutlookCardStyle => {
    return {
        'none': {
            ...
            background: 'bg-puregray-50 dark:bg-puregray-950',
        ...
        'medium': {
            border: 'border-yelloworange-200 dark:border-yelloworange-700',
